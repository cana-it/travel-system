...
export const InvoicePaymentSlips = () => {
  ...
  const [titleShow, setTitleShow] = useState("TẤT CẢ PHIẾU PĐX");
      ...
      const pr = {
        ...
        FromDate:
          state.TimeSearch !== undefined
            ? FormatDateJson(state.TimeSearch[0])
            : "01/01/2000",
        ToDate:
          state.TimeSearch !== undefined
            ? FormatDateJson(state.TimeSearch[1])
            : "01/01/2000",
        CheckDate: "A",
      };
  ...
  const columns = [
    {
      ...
      Cell: ({ row }) => (
        ...
        >
          ...
          {(row._original.Creater === +Creater || +Creater === 1) &&
  ...
  //#region Modal xác nhận PHIẾU PĐX
  ...
  return (
    <>
      <div className="content-wrapper pt-1 px-2 pb-2">
        <div class="card p-1 PrintInvoiceHide">
          <div class="card-header border-left-red">
            <div class="row">
              <div class="col-sm-12 col-md-3 margin-top-5s">PHIẾU PĐX</div>
              ...
              >
                <div className="info-box">
                  ...
                  <div className="info-box-content">
                    <span className="info-box-text">TỔNG PHIẾU PĐX CHỜ</span>
        ...
        <Modal.Body>
          ...
          >
            ...
            <div className="col-sm-12">
              <div className="row">
                <div class="col-sm-12 text-center mt-2">
                  <span style={{ fontSize: "25px", fontWeight: 700 }}>PĐX</span>
                ...
                <div class="col-sm-12 mb-4">
                  <div className="row">
                    ...
                    <div className="col-sm-6">
                      ...
                      {invoiceView?.CustomerNamePayment || ""}
                    </div>
                    <div className="col-sm-6">
            ...
            {/* <div className="clearfix"></div>
                        ...
                        />
                        <div className="col-md-12 col-sm-12">
                            <InvoiceConfirmTemp onInvoice={invoiceView} />
                        </div> */}
            <div className="clearfix"></div>
      ...
      >
        <Modal.Header>
          <Modal.Title id="example-custom-modal-styling-title">
            <div class="text-center">TẠO PHIẾU PĐX</div>
          </Modal.Title>
          <Button
            type="button"
            className="close"
