...
export const CostSettlementDetailTableComp = ({
  ListData = [],
  CostTypeId = "",
  CostTypeName = "",
  onData = () => {},
        ...
        >
          <thead>
            <tr>
              ...
              <th style={customStyles.th150}>ĐỊA ĐIỂM</th>
              <th style={customStyles.th}>HẠNG MỤC</th>
              <th style={customStyles.th150}>CHI PHÍ THỰC TẾ</th>
            </tr>
          </thead>
          <tbody>
