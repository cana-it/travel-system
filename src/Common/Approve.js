        ...
        <div class="border-left-red card-header  bg-ab ">
          <div class="row ">
            <div class="col-sm-12 col-md-2 cardtext ">
              <h3 class="card-title font-weight-bold ">Phê duyệt </h3>
            </div>
            ...
            <div className="card-body approve">
              <button
                onClick={VideAdd}
                type="button"
                class="btn btn-sm btn-success pull-right margin-left-5 margin-bottom-20 margin-top-20"
              >
              ...
              <button
                ...
                type="button"
                class="btn btn-sm btn-danger pull-right margin-left-10 margin-top-20 "
              >
              ...
              <div
                ...
                style={{ marginTop: "5px", width: "20%", marginLeft: "5px" }}
              >
                <div
                  class="input-group margin-top-10"
                  style={{ width: "100%" }}
                >
                  <input
                    type="text"
